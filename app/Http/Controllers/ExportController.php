...
class ExportController extends Controller
{
    public function getComprobante($id){
        ...
        try{
            ...
            $link = "http://server2.d-todoimports.com/api/dowloadXml/".$comprobante[0]->serie."-".$comprobante[0]->correlativo."/".$comprobante[0]->tipoDocumento_id."/".$comprobante[0]->empresa_id;
